...
LGS = list_log_group_streams('/aws/lambda/logtest-bea2', region_name='ap-southeast-1')
print('\nLog Group Name: ', LG)
...
FLG = filter_log_events('/aws/lambda/logtest-bea2', 'INFO Function start', region_name='ap-southeast-1')
...
filter_log_events(
    '/aws/lambda/logtest-bea2', 'INFO Function start',
